...
#fi
export     MY_ROOT_DIR=${HOME}/PFM/roms
export     MY_PROJECT_DIR=${HOME}/PFM/test_upwelling
...
if [ $pio_lib -eq 1 ]; then
 export           USE_PIO=off            # Parallel I/O with PIO library
fi
...
export      NETCDF_LIBDIR=/usr/lib64/openmpi/lib    # Replace with your result
fi
